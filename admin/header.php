...
<head>
    ...
    <title>Medical Appointment Management System</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            ?>
             <a class="sidebar-brand d-flex align-items-center justify-content-center" href="doctor_dashboard.php">
             <?php
            }
            ?>
                ...
                <div class="sidebar-brand-text mx-3">Basis Medical Appointment</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h2><?php echo $_SESSION['type']."'s"; ?> Dashboard</h2>
