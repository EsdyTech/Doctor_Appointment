...
<html lang="en">
	...
	<body>
		<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-danger border-bottom box-shadow">
			<div class="col">
		    	<h5 class="my-0 mr-md-auto font-weight-normal"><a href="index.php" class="text-white" style="text-decoration: none;">BASIS HOSPITAL - Medical Appointment</a></h5>
		    </div>
		    <?php
		    ...
		    <div class="col text-right">
				...
				&nbsp;&nbsp;&nbsp;<a href="appointment_schedule.php" class="text-white" style="text-decoration: none;">Appointments Schedule</a>
				&nbsp;&nbsp;&nbsp;<a href="admin/index.php" class="text-white" style="text-decoration: none;">Admin/Doctor</a>
		</div>
		   	<?php
		   	}
		   	?>
	    ...
	    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-left">
	      	<h3 class="display-4">Patient's Dashboard</h3>
	    </div>
		<?php
		   	}
		   	?>
